...
const SIZES_1D: &[usize] = &[
    100, 128, 378, 512, 640, 783, 800, 900, 1000, 2000, 4000, 10000, 20000, 50000, 100000, 200000,
];
...
// Helper functions for 3D tensors
...
// Helper functions for 2D Candle tensors
...
// Helper functions for 3D Candle tensors
...
// 2D tensor benchmarks for f16 - SLSL vs Candle comparison
...
// 3D tensor benchmarks for f16 - SLSL vs Candle comparison
fn bench_3d_softmax_f16_comparison(c: &mut Criterion) {
    ...
    for &(d1, d2, d3) in SIZES_3D {
        ...
        // Benchmark softmax along different dimensions
        for dim in 0..3 {
            group.bench_with_input(
...
// 3D tensor benchmarks for f32 - SLSL vs Candle comparison
